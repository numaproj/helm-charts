...
numaproj/numaflow       0.5.3           1.8.3           A Helm chart for installing Numaflow in Kubernetes
numaproj/numaflow       0.5.2           1.8.2           A Helm chart for installing Numaflow in Kubernetes
numaproj/numaflow       0.5.1           1.8.1           A Helm chart for installing Numaflow in Kubernetes
numaproj/numaflow       0.5.0           1.8.0           A Helm chart for installing Numaflow in Kubernetes
numaproj/numaflow       0.4.5           1.7.5           A Helm chart for installing Numaflow in Kubernetes
...
numaproj/numaflow       0.4.0           1.7.0           A Helm chart for installing Numaflow in Kubernetes
