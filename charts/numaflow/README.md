...
```bash
helm repo add numaflow https://numaproj.github.io/helm-chart/
```
Output:

```
NAME            URL
numaflow     https://numaproj.github.io/helm-chart/
```
...
> ```bash
> helm install numaflow numaflow/helm-chart --namespace numaflow-system --set server.configs.namespacedScope=true --create-namespace
> ```
...
```bash
NAME: numaflow
LAST DEPLOYED: Wed Dec 27 23:24:34 2023
